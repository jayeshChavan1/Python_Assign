...
psql_form = """INSERT INTO twitter1 (name, username, followers, following, tweets) VALUES (%s, %s, %s, %s, %s)"""

mycursor.execute(psql_form,user_info_list)

myconn.commit()

# psql_select_Query = "select * from twitter"
